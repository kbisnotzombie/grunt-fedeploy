...
//			 src: 'testDest/jsp',
    ...
    shell:{
        execQrsync:{
        	command:'qrsync /var/duobei/qiniu-config/qiniu-conf.json'
        }
//        execQrsync1:{
//            command:'qrsync /var/duobei/qiniu-config/qiniu-conf1.json'
//        }
    },
  ...
  // Default task.
  grunt.registerTask('prod', ['copy:jsp', 'less', 'replace', 'concatMin', 'replaceJspStatic', 'clean', 'copy:copyStatic', 'cssmin', 'changeSourceMapPath','shell']);
  grunt.registerTask('deploy', ['copy:jsp', 'less', 'replace', 'concatMin', 'replaceJspStatic', 'clean', 'copy:copyStatic', 'cssmin', 'changeSourceMapPath','copy:depoyFront','shell']);

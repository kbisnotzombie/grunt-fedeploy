				 ...
				 if(extname == ext){
					 try{
						 ...
						 lessContent.forEach(function(t){
							 var hashCode = utils.md5(lessBuildCssDir+ '/' + t + '.css').slice(0, 9);
						 ...
						 jsContent.forEach(function(t){ 
							 var hashCode = utils.md5(jsDir+ '/' + t + '.js').slice(0, 9);
							 destContents = destContents.replace("lib/"+ t + '.js', "lib/"+ t + '.js?v=' + hashCode);
						 });
						 
						 //remove the mockjax.js and related js,START
						 destContents = destContents.replace(/\<duobei:script.*?src="page-mockjax\/(.+).js.*?".*?\/\>/g,'');
						 destContents = destContents.replace(/\<script.*?src=".*?page-mockjax\/(.+).js.*?".*?\>\<\/script\>/g,'');
						 //remove the mockjax.js and related js,END
